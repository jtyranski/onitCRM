...
$sql = "SELECT logo from master_list where master_id='" . $company['master_id'] . "'";
...
function checkform(f){
  ...
  if(foo ==0 && f.check1.checked==true) { errmsg += "You need to select at least one deficiency.\n"; }
  if(f.check1.checked==false && f.check2.checked==false && f.send_unsigned.checked==false) { errmsg += "Please select at least one option.\n";}
...
<body>
<div align="center">
<div style="position:relative; background-image:url(images/ipad_frame.jpg); width:1024px; height:1314px; background-repeat:no-repeat;">

<div style="font-family:Arial, Helvetica, sans-serif; width:770px; position:absolute; left:125px; top:140px; height:1040px; overflow:auto;">
...
$body = str_replace("width:850px;", "", $body);
