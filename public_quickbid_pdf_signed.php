	...
	public function TopInfo($showleak=0){
	  ...
	  */
	  ...
	  if($showleak==0){
	    ...
	    $this->MultiCell(0, 10, "The deficiencies shown are the deficiencies your representative has reviewed with you and you have selected for authorized repair.", 0, 'C', false, 1);
...
date_format(sign_date, \"%m/%d/%Y %r\") as sign_date_pretty, property_id, signature_image, leak_id, maintenance_program_check, maintenance_program, program_cost, 
...
$maintenance_program_check = stripslashes($record['maintenance_program_check']);
...
$pdf->Cell(65, 0, $name, 0, 0, "L");
$pdf->Cell(14, 0, "Email:", 0, 0, "L");
