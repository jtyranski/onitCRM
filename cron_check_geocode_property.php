...
$sql = "SELECT property_id from check_latlng where property_id != 0 group by property_id";
...
while ($record = go_fetch_array($result)){
  ...
  $sql = "SELECT property_id, address, city, state from properties where property_id='$property_id'";
...
$sql = "DELETE from check_latlng where property_id != 0";
executeupdate($sql);
