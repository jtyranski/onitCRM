...
function delcat(x){
  ...
  if(cf){
    document.location.href="admin_mat_category_delete.php?category_id=" + x;
  }
}
</script>

<div class="main">
<a href="admin_mat.php">Return to materials list</a><br><br>

<a href="admin_mat_category_edit.php?category_id=new">Add a new category</a>
...
while($record = go_fetch_array($result)){
  ...
  <td><a href="admin_mat_category_edit.php?category_id=<?=$record['category_id']?>">Edit</a></td>
