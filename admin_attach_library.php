...
function DelItem(attach_id){
  ...
  if(cf){
    document.location.href="admin_attach_library_delete.php?attach_id=" + attach_id;
  }
}
</script>
<div class="main">

<a href="admin_attach_library_edit.php?attach_id=new">Add new file</a>
<br>
...
while($record = go_fetch_array($result)){
  ...
  <td><a href="admin_attach_library_edit.php?attach_id=<?=$record['attach_id']?>">Edit</a></td>
