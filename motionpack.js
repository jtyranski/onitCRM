...
function slideGenerate(firstRecord, direction, url, cand_type, prospecting){
  url=url + "?firstrecord=" + firstRecord + "&direction=" + direction + "&cand_type=" + cand_type + "&prospecting=" + prospecting;
...
function divswitch(divname){
	div2 = document.getElementById(divname + '2').innerHTML;
	document.getElementById(divname + '1').innerHTML = div2;
	document.getElementById(divname + '2').innerHTML = "";
	document.getElementById(divname + '1').style.display="block";
