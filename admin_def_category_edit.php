...
if($category_id != "new"){
  $sql = "SELECT master_id from def_list_categories where category_id ='$category_id'";
  $master_id = getsingleresult($sql);
  if($master_id != $SESSION_MASTER_ID) exit;
  
  $sql = "SELECT * from def_list_categories where category_id='$category_id'";
...
<div class="main">
<form action="admin_def_category_edit_action.php" method="post" onSubmit="return checkform(this)">
