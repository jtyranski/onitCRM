...
include $language;
$msg = $_REQUEST["msg"];
if (!$SESSION_SUPERCALI_USER_ID) $SESSION_SUPERCALI_USER_ID = 1;
...
$query = mysql_query("SELECT view, post, add_categories, add_groups, add_users from ".$table_prefix."users where user_id = ".$SESSION_SUPERCALI_USER_ID." limit 1");
...
// added by JW 7/7/2010.  If Operations, make default module be 5, the Gantt page
...
$_SESSION['supercali_calendar_type'] = $calendar_type;

$_SESSION["o"]="";

if($calendar_type=="Operations") $default_module = 5;
if($calendar_type=="Programming") $default_module = 7;
if($calendar_type=="ProgrammingComplete"){
  //echo "<!-- it's programming complete -->\n";
  $default_module = 8;
}
if($calendar_type=="ProgrammingIncomplete"){
  //echo "<!-- it's programming complete -->\n";
  $default_module = 9;
}
...
if($calendar_type=="ProgrammingDev"){
  //echo "<!-- it's programming complete -->\n";
  $default_module = 11;
}

if($calendar_type=="SalesGantt"){
  //echo "<!-- it's programming complete -->\n";
  $default_module = 5;
}
