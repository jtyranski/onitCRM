...
function showGantt ($calmonth,$calyear) {
	...
	for($x=1;$x<=$showmonths;$x++){
	  $y = $x - 1;
	  $header_display = $prev_click . date('F', mktime(0,0,0,$calmonth + $y,1,$calyear)) . '&nbsp;' . date('Y', mktime(0,0,0,$calmonth + $y,1,$calyear)) . $next_click;
	  if($x==1 && $month_info[$x]['days'] < 10) $header_display = $prev_click . date('M', mktime(0,0,0,$calmonth + $y,1,$calyear)) . '&nbsp;' . date('Y', mktime(0,0,0,$calmonth + $y,1,$calyear)) . $next_click;
	  if($x==1 && $month_info[$x]['days'] < 5) $header_display = $prev_click . date('M', mktime(0,0,0,$calmonth + $y,1,$calyear)) . $next_click;
