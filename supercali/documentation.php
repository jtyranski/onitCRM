...
<li>Place the compressed download file in the Web accessible directory you wish to install SuperCali and uncompress it.  If installing on a Linux or Unix server, the command is:<div class="code">tar xzf supercali-1.0.5.tar.gz</div></p>
</li>
...
<h3>Basic FCKeditor Integration</h3>
<ul>
<li><p>Place the compressed FCKeditor download file in your main SuperCali directory and uncompress it.  If installing on a Linux or Unix server, the command is:
<div class="code">tar xzf FCKeditor*</div></p></li>
<li><p>Edit the SuperCali configuration file, &quot;config.php,&quot; and change the value of $fck_editor_path to the url path of newly created FCKeditor directory.  For example, if your calendar is found at: &quot;http://www.example.com/calendar/&quot; you will set <span class="code">$fck_editor_path = &quot;fckeditor/&quot;;</span>.</p></li>
<li>For more HTML formating tools, $fck_editor_path can be set to &quot;Default&quot;  Please see the FCKeditor documentation for more information on using FCKeditor.</li>
