...
<table>
	...
	*/ ?>
	<input type="hidden" name="sub_of" value="0">
...
if (!$SESSION_SUPERCALI_USER_ID) {
	...
	$query = mysql_query("SELECT add_categories from ".$table_prefix."users where user_id = ".$SESSION_SUPERCALI_USER_ID." limit 1");
