...
?>
<div align="left">
<form action="unsubscribe_opm_action.php" method="post" name="subscribe">
<input type="hidden" name="code" value="<?=$code?>">
<table class="main">
<tr>
<td colspan="2">Please enter the email address you would like removed from this OPM emailer.</td>
</tr>
<tr>
<td colspan="2">
